...
gt_file = './val_filelists/objectnet_imagenet_c_r_o_filelist.txt'
submit_file = './my_results/example_results/source_only_pred.txt'
a = check_file_name(gt_file,submit_file)
